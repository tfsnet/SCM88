...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/tfsnet/izin/master/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/tfsnet/izin/master/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/tfsnet/izin/master/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
# REPOSITORY    
    REPO="https://raw.githubusercontent.com/tfsnet/SCM88/master/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/tfsnet/izin/master/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/tfsnet/izin/master/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://wa.me/6281324677787"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6281324677787"}]]}'
...
wget raw.githubusercontent.com/tfsnet/SCM88/master/files/limit.sh && chmod +x limit.sh && ./limit.sh
...
#git clone  https://github.com/tfsnet/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
